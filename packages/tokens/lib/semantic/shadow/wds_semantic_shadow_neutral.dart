...
class WdsSemanticShadowNeutral {
  ...
  static const List<BoxShadow> emphasize = [
    ...
    BoxShadow(blurRadius: WdsAtomicBlur.v1, color: Color(0x14000000)),
  ];
  static const List<BoxShadow> heavy = [
    ...
    BoxShadow(blurRadius: WdsAtomicBlur.v8, color: Color(0x14000000)),
  ];
  ...
  static const List<BoxShadow> strong = [
    ...
    BoxShadow(blurRadius: WdsAtomicBlur.v4, color: Color(0x14000000)),
  ];
}
